pipeline {
    ...
    environment {
        DOCKER_IMAGE = 'asilkyun158/server_golang'
        DOCKER_TAG = 'latest'
        PROD_SERVER = 'ec2-13-213-59-130.ap-southeast-1.compute.amazonaws.com'
        PROD_USER = 'ubuntu'
        TELEGRAM_BOT_TOKEN='7888508993:AAFFqz7YUt9CdkxfMRuXWlhYScM7RfTlirk'
        TELEGRAM_CHAT_ID='-1002319891876'
    }

    stages {
        stage('Clone Repository') {
            steps {
                git branch: 'master', url: 'https://github.com/phantuanthanh1582000/server_golang.git'
            }
        }
